...
echo
echo $pur"==================="$cy" ============================="
echo $i"Ôûê"$pu"  AUTHOR  :  TERMUX ID  "$i"                    Ôûê"
echo $i"Ôûê"$pu"  WhatsApp:  083140299364"$i"                Ôûê"
echo $i"Ôûê"$pu"  GMAIL   :  rendiroot@gmail.com"$i"     Ôûê"
echo $i"Ôûê"$pu"  YOUTUBE :  TERMUX ID"$i"                 Ôûê"
echo $pur"==================="$cy" ============================="
echo
...
then
clear
figlet -f slant "SABAR NJINK"|lolcat
sleep 1
...
then
clear
figlet -f slant "SABAR NJINK"|Ulolcat
sleep 2
echo $cy"TERIMA KASIH TELAH MEMAKAI TOOLS KAMI"
sleep 2
echo $i"SILAHKAN GUNAKAN TOOLS INI KAPAN SAJA SEMOGA BERMANFAAT"
sleep 2
echo $pur"BILA TERJADI BUG ATAU KESALAH HUBUNGI SAYA VIA "
sleep 2
echo $ku"Facebook :"$i" レンディ ラマダ"
echo $ku"YouTube  :"$i" TERMUX ID"
echo $ku"WhatsApp :"$i" 083140299364"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { TERMUX ID }"
echo $ku "TUNGGU UPDATE NYA OK"
exit
fi
